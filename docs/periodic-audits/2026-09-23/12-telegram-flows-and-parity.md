...
### 8. الأولويات والقرار الاستراتيجي
1. **قرار التأجيل المعماري المعتمد (Postponed by Sovereign Strategic Decision):** تم تأجيل معالجة هذه الجزئية بقرار استراتيجي معتمد من المالك والمهندس المعماري (`/saleh`)، نظراً لأن كافة التدفقات والأزرار الحالية بُنيت قبل اكتمال اعتماد موسوعة تليجرام الرسمية ومحرر النصوص الغنية، وسيتم إخضاع كامل تدفقات المنظومة الـ 126 لعملية إعادة هيكلة جذرية وشاملة لاحقاً وفق معيار `@alsaada/core-components/rich-message` بدلاً من الترقيع الجزئي المحدود.

---

### 9. التوثيق الرسمي لقرار التأجيل المعماري (Sovereign Strategic Decision Record)

> [!IMPORTANT]
> **قرار المالك والمهندس المعماري المؤسسي (`/saleh` — Sovereign Executive Decision):**  
> **الحالة:** ⏸️ **مؤجلة رسمياً لإعادة الهيكلة الشاملة (Postponed for Comprehensive Rich Message Refactor)**  
> **المرجعية:** توجيه المالك الصادر بتاريخ 2026-09-23T18:21:31+03:00.  
> 
> **الأسباب والمسوغات المعمارية:**
> 1. **شمولية القصور في كافة التدفقات:** التدفقات الـ 22 القائمة بأكملها صُممت بأسلوب واجهات تليجرام التقليدية قبل الإلزام الصارم بمحرر النصوص الغنية (`@alsaada/core-components/rich-message`) والموسوعة المرجعية الرسمية لتليجرام (Work Plan 95).
> 2. **حظر الترقيع المؤقت (Anti-Churn Policy):** إن إجراء تعديلات جزئية موضعية لترقيع النصوص وتعديل أطوال الأزرار الحالية يعتبر هدراً تقنياً وجهداً مكرراً (Wasteful Churn)، لأن جميع هذه الشاشات والأزرار ستُعاد صياغتها بالكامل من الصفر ضمن مسار التحول المعماري الشامل للنصوص الغنية.
> 3. **النطاق المستقبلي:** سيتم إدراج معالجة هذه الإخفاقات كـ **مشروع إعادة هيكلة شامل (Comprehensive Rich-Message & UX Restructuring Work Plan)** يغطي كافة تدفقات البوت الـ 126 دفعة واحدة، مع توحيد كتل العرض، وتطبيق ميزانية الأزرار (36/16/7/3)، واستيفاء مخططات Mermaid في أدلة الاستخدام دون استثناء.
