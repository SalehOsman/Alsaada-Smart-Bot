...
- [x] **المرحلة 1:** تأسيس تطبيق البوابة `apps/docs` وإعداد Astro Starlight.
- [x] **المرحلة 2:** بناء محول الـ AST الذكي `tools/docs/transform-pipeline.ts` وتصحيح الروابط.
- [x] **المرحلة 3:** برمجة هندسة المعلومات وشجرة التصفح الشاملة للمسارات الستة.
- [x] **المرحلة 4:** تفعيل Pan & Zoom للمخططات الكبرى وتضمين خريطة الاعتماديات الحية.
- [x] **المرحلة 5:** فواحص الحوكمة والربط التلقائي في `package.json` و `pre-commit`.
