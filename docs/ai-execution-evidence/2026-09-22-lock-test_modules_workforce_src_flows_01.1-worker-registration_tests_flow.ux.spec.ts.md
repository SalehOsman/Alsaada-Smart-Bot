...
- **المسار الأساسي:** `modules/workforce/src/flows/01.1-worker-registration/tests/flow.ux.spec.ts`
...
| :--- | :--- |
| `modules/workforce/src/flows/01.1-worker-registration/tests/flow.ux.spec.ts` | `36faf36f7cb2de3bb06c41717c39d789cb79d452e2f359923902302abae266cb` |
