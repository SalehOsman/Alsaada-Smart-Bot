...
- **المسار الأساسي:** `modules/settings/src/flows/00.1-corporate-profile/tests/flow.integration.spec.ts`
...
| :--- | :--- |
| `modules/settings/src/flows/00.1-corporate-profile/tests/flow.integration.spec.ts` | `8fa0e8c595cb951c869abbd044aa7039e77160a7fa14182ab1671b999d3cdcf0` |
