...
export function ZeroStateCard({
  ...
  return (
    <div
      ...
      className={`bg-white rounded-xl border border-slate-200 p-8 sm:p-12 text-center flex flex-col items-center justify-center space-y-4 shadow-2xs transition-all ${className}`}
    >
      {/* Brand Safety Orange Icon Badge */}
      <div
        data-testid="zero-state-icon-badge"
        className="w-14 h-14 rounded-2xl bg-orange-50 text-orange-600 flex items-center justify-center border border-orange-200/60 shadow-xs"
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          {onResetFilter && (
            <button
              ...
              className="min-h-[44px] px-4 py-2 rounded-lg bg-slate-100 text-slate-700 text-xs sm:text-sm font-semibold hover:bg-slate-200 transition-colors cursor-pointer border border-slate-200/60"
            >
