    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-slate-500">
          ...
          <span>/</span>
          <span className="text-slate-800 font-semibold">🚜 تشغيل المواقع والإنتاج</span>
        </nav>
        ...
        <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl flex items-center gap-3 text-amber-900">
          ...
          <div>
            <h4 className="font-bold text-sm">
              تنبيه الصيانة والتشغيل: توجد ({brokenDownEquipments}) معدة معطلة و ({maintenanceEquipments}) معدة بحاجة لصيانة دورية!
            </h4>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <div className="mt-2 text-lg sm:text-2xl font-black text-slate-900">
            {operationalEquipments} <span className="text-xs font-medium text-slate-500">من {totalEquipments} معدة</span>
          </div>
          <p className="text-[11px] text-slate-400 mt-1">معدات وآليات قيد العمل</p>
        </div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <div className="mt-2 text-lg sm:text-2xl font-black text-slate-900">
            {sitesList.length} <span className="text-xs font-medium text-slate-500">موقع</span>
          </div>
          <p className="text-[11px] text-slate-400 mt-1">مشاريع تعدين ومواقع نشطة</p>
        </div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <div className="mt-2 text-lg sm:text-2xl font-black text-slate-900">
            {totalFuelStockLiters.toLocaleString('ar-EG')} <span className="text-xs font-medium text-slate-500">لتر</span>
          </div>
          <p className="text-[11px] text-slate-400 mt-1">موزع على ({fuelTanksCount}) صهريج ميداني</p>
        </div>

        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
          <div className="flex items-center justify-between text-slate-500 text-xs font-medium">
            <span>إجمالي الإنتاج المستخرج</span>
            <Pickaxe className="w-4 h-4 text-slate-600" />
          </div>
          <div className="mt-2 text-lg sm:text-2xl font-black text-slate-900">
            {totalExtractionTons.toLocaleString('ar-EG')} <span className="text-xs font-medium text-slate-500">طن</span>
          </div>
          <p className="text-[11px] text-slate-400 mt-1">خام الفوسفات المستخرج والمشحون</p>
        </div>
      </div>
                  ...
                  <tr key={site.id} className="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td className="px-4 py-3 text-left">
                      <Link
                        ...
                        className="text-xs text-orange-600 hover:text-orange-700 font-semibold min-h-[44px] min-w-[44px] inline-flex items-center justify-center px-2"
                      >
                        معدات الموقع &larr;
                      </Link>
                    </td>
