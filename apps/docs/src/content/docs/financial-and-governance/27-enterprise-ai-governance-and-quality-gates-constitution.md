---
title: "📜 دستور حوكمة الذكاء الاصطناعي وبوابات الجودة المؤسسية الموحدة"
...
1. **المشروع المرجعي السابق (`F:\HR`) هو الأساس لكافة الوظائف والتدفقات الـ 126:**
   - مشروعنا السابق ``F:\HR`` هو المرجع الحصري لكافة الوظائف والخيارات والشاشات وقواعد العمل المحاسبية.
...
3. **التوثيق الحتمي المتزامن ومكافحة الانحراف التوثيقي (`Zero Documentation Drift`):**
   ...
   - التحديث الفوري والإلزامي لسجل الترحيل الرئيسي [`docs/19-legacy-to-enterprise-master-feature-migration-registry.md`](/data-and-migration/19-legacy-to-enterprise-master-feature-migration-registry/) إلى `🟢 مكتمل وموثق 100%` وتدوين مسار التدفق وتاريخ ورقم الـ Commit.
...
3. **حظر المزامنة اللحظية المباشرة مع Google Sheets:**
   - قاعدة البيانات المحلية هي مصدر الحفظ الفوري السريع (< 15ms)، وعمليات الترحيل الخارجي لـ Google Sheets تُدار كأحداث خلفية عبر طابور المزامنة الصامت [`TransactionalOutboxQueue`](https://github.com/SalehOsman/Alsaada-Smart-Bot/tree/main/packages/core-components).
