...
export function commitmentListKeyboard(
...
export function cardActionsKeyboard(workerId: string, isWorkerRole = false): InlineKeyboard {
  if (isWorkerRole) {
...
export function workerPickerKeyboard(options: {
...
export const WorkerCommitmentKeyboards = {
  mainMenuKeyboard,
  commitmentListKeyboard,
  cardActionsKeyboard,
  searchCancelKeyboard,
  workerPickerKeyboard,
} as const;
