...
export class WorkerDirectoryKeyboards {
  ...
  static documentCategoryPickerKeyboard(workerId: string): InlineKeyboard {
  ...
  static cancelDocUploadKeyboard(workerId: string): InlineKeyboard {
    return new InlineKeyboard()
      .text('◀️ إلغاء والعودة للمستندات', `action:worker:docs:${workerId}`);
  }
