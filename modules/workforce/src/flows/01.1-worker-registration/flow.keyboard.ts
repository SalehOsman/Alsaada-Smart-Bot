...
export function docTypeKeyboard(): InlineKeyboard {
...
export function photoPromptKeyboard(hasBack = true): InlineKeyboard {
...
export function textInputKeyboard(hasBack = true): InlineKeyboard {
  const kb = new InlineKeyboard();
  if (hasBack) {
    kb.text('◀️ السابق', 'wizard:worker:back');
  }
...
export function nicknameSuggestionKeyboard(firstTwo: string): InlineKeyboard {
  return new InlineKeyboard()
...
export function payoutTransferChoiceKeyboard(phone: string): InlineKeyboard {
  return new InlineKeyboard()
...
export function customWalletKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
    .text('◀️ السابق', 'wizard:worker:back')
    .text('❌ إلغاء', 'wizard:worker:cancel');
}

export function payoutMethodKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function startDateKeyboard(): InlineKeyboard {
...
export function drivingLicenseKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function militaryStatusKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function emergencyPhoneKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function insuranceStatusKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function maritalStatusKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function optionsGridKeyboard(
...
export function simpleChoiceKeyboard(choices: { label: string; value: string }[], prefix: string): InlineKeyboard {
  const kb = new InlineKeyboard();
...
export function completionKeyboard(welcomeWhatsAppUrl: string): InlineKeyboard {
...
export function cancelExitKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function interactiveErrorKeyboard(retryStep: string): InlineKeyboard {
  return new InlineKeyboard()
...
export function aiConfirmationKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function getStepKeyboard(
...
export const WorkerRegistrationKeyboards = {
  docTypeKeyboard,
  photoPromptKeyboard,
  textInputKeyboard,
  nicknameSuggestionKeyboard,
  payoutTransferChoiceKeyboard,
  customWalletKeyboard,
  payoutMethodKeyboard,
  startDateKeyboard,
  drivingLicenseKeyboard,
  militaryStatusKeyboard,
  emergencyPhoneKeyboard,
  insuranceStatusKeyboard,
  maritalStatusKeyboard,
  optionsGridKeyboard,
  simpleChoiceKeyboard,
  confirmationKeyboard,
  completionKeyboard,
  cancelExitKeyboard,
  interactiveErrorKeyboard,
  processingKeyboard,
  aiConfirmationKeyboard,
  getStepKeyboard,
} as const;
