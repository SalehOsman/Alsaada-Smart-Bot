...
export function templateDownloadKeyboard(): InlineKeyboard {
...
export function uploadPromptKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function exportMenuKeyboard(): InlineKeyboard {
  return new InlineKeyboard()
...
export function departmentFilterKeyboard(departments: DepartmentSummary[]): InlineKeyboard {
...
export function jobTitleFilterKeyboard(
...
export function governorateFilterKeyboard(
...
export function importSuccessKeyboard(): InlineKeyboard {
...
export function exportSuccessKeyboard(): InlineKeyboard {
  return buildCompletionKeyboard({
...
export function errorRetryKeyboard(retryAction: string, backAction: string): InlineKeyboard {
  return new InlineKeyboard()
...
export const WorkerExportKeyboards = {
  templateDownloadKeyboard,
  uploadPromptKeyboard,
  exportMenuKeyboard,
  departmentFilterKeyboard,
  jobTitleFilterKeyboard,
  governorateFilterKeyboard,
  importSuccessKeyboard,
  exportSuccessKeyboard,
  errorRetryKeyboard,
} as const;
