...
export function workerProfileTabsKeyboard(
  workerId: string,
  ...
  if (activeTab === 'PERSONAL') {
    ...
    kb.text('🥾 مقاس حذاء السيفتي', `action:w_edit:pk:ppes:${workerId}`)
      ...
      .row();
    kb.text('🔗 ربط / تعديل معرف تليجرام', `action:w_edit:f:tgid:${workerId}`)
      .text('🔓 إلغاء ربط حساب تليجرام', `act:wrk:unlink:${workerId}`)
      .row();
  }
...
export function cigarettePolicyKeyboard(workerId: string): InlineKeyboard {
...
export function cigaretteBrandKeyboard(
  workerId: string,
...
export function discretePickerKeyboard(fieldShort: string, workerId: string, returnTab: WorkerProfileTab): InlineKeyboard {
  const kb = new InlineKeyboard();
...
export function entityPickerKeyboard(
...
export function salaryEffectiveDateKeyboard(workerId: string): InlineKeyboard {
  return new InlineKeyboard()
...
export function salaryConfirmKeyboard(workerId: string): InlineKeyboard {
  return new InlineKeyboard()
...
export function timelineBackKeyboard(workerId: string, returnTab: WorkerProfileTab = 'FINANCE'): InlineKeyboard {
  return new InlineKeyboard()
...
export function fieldsSelectionKeyboard(workerId: string): InlineKeyboard {
  return workerProfileTabsKeyboard(workerId, 'PERSONAL');
}

export function cancelEditKeyboard(workerId?: string, returnTab: WorkerProfileTab = 'PERSONAL'): InlineKeyboard {
  const kb = new InlineKeyboard();
  if (workerId) {
...
export function ticketReviewKeyboard(ticketId: string): InlineKeyboard {
  return new InlineKeyboard()
...
export function pendingTicketsListKeyboard(tickets: PendingEditTicket[]): InlineKeyboard {
  const kb = new InlineKeyboard();
...
export function directEditSuccessKeyboard(workerId?: string, tab: WorkerProfileTab = 'PERSONAL'): InlineKeyboard {
...
export const WorkerEditKeyboards = {
  workerProfileTabsKeyboard,
  cigarettePolicyKeyboard,
  cigaretteBrandKeyboard,
  discretePickerKeyboard,
  entityPickerKeyboard,
  salaryEffectiveDateKeyboard,
  salaryConfirmKeyboard,
  timelineBackKeyboard,
  fieldsSelectionKeyboard,
  cancelEditKeyboard,
  ticketReviewKeyboard,
  pendingTicketsListKeyboard,
  directEditSuccessKeyboard,
} as const;
