...
export const workerStorageService = new WorkerStorageService();
export const googleDriveService = workerStorageService;
export { WorkerStorageService as GoogleDriveService };
